...
def convert_shape_format(shape):
    ...
    """
    positions = []
    index = shape.shape[shape.rotation % len(shape.shape)]
...
def draw_grid(surface,grid):
    ...
    :return: the surface with grey lines drawn on it in a grid patter
    """
    sx = top_left_x
    sy = top_left_y
...
def draw_window(surface,grid, score=0, last_score=0):
    ...
    # current score
    font = pygame.font.SysFont('comicsans', 30)
    label = font.render('Score: ' + str(score), 2, (255,255,255))
    ...
    label = font.render('High Score: ' + str(last_score), 2, (255,255,255))
...
def main(win):
    ...
    while run:
        ...
        if change_piece:
            ...
            next_piece = get_shape()
            change_piece = False
            score += clear_rows(grid, locked_positions) * 5
